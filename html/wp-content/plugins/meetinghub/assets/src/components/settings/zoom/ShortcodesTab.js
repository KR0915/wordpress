...
const shortcodes = [
  { title: langString('zoom_meeting_list') , description: langString('embed_zoom_meetings'), code: "[mhub-zoom-meeting-list]" },
  { title: langString('zoom_webinar_list') , description: langString('embed_zoom_webinars'), code: "[mhub-zoom-webinar-list]" },
];
